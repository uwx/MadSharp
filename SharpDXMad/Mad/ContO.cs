...
namespace MadGame
{
    public class ContO
    {
        ...
        public ContO(Medium medium, ContO conto, int i, int j, int k)
        {
            ...
            for (var l = 0; l < npl; l++)
                p[l] = new Plane(m, conto.p[l].ox, conto.p[l].oz, conto.p[l].oy, conto.p[l].n, conto.p[l].c,
                    conto.p[l].glass, conto.p[l].gr, conto.p[l].fs, conto.p[l].wx, conto.p[l].wz);
        }
        ...
        public void d()
        {
            ...
            if (!_out)
            {
                var i = m.cx + (int) ((x - m.x - m.cx) * Math.Cos(m.xz * 0.017453292519943295D) -
                                      (z - m.z - m.cz) * Math.Sin(m.xz * 0.017453292519943295D));
                var j = m.cz + (int) ((x - m.x - m.cx) * Math.Sin(m.xz * 0.017453292519943295D) +
                                      (z - m.z - m.cz) * Math.Cos(m.xz * 0.017453292519943295D));
                var k = m.cz + (int) ((y - m.y - m.cy) * Math.Sin(m.zy * 0.017453292519943295D) +
                    ...
                    xs(i + maxR, k) - xs(i - maxR, k) > disp)
                {
                    if (shadow)
                    {
                        var l = m.cy + (int) ((m.ground - m.cy) * Math.Cos(m.zy * 0.017453292519943295D) -
                                              (j - m.cz) * Math.Sin(m.zy * 0.017453292519943295D));
                        var j1 = m.cz + (int) ((m.ground - m.cy) * Math.Sin(m.zy * 0.017453292519943295D) +
                                               (j - m.cz) * Math.Cos(m.zy * 0.017453292519943295D));
                    ...
                    var i1 = m.cy + (int) ((y - m.y - m.cy) * Math.Cos(m.zy * 0.017453292519943295D) -
                                           (j - m.cz) * Math.Sin(m.zy * 0.017453292519943295D));
                    if (ys(i1 + maxR, k) > 0 && ys(i1 - maxR, k) < m.h)
                    {
                        ...
                        dist = (int) Math.Sqrt((int) Math.Sqrt(
                                   ((m.x + m.cx) - x) * ((m.x + m.cx) - x) + (m.z - z) * (m.z - z) +
                ...
                if (i < (maxR / 10) * (maxR / 10) + (conto.maxR / 10) * (conto.maxR / 10) && i > 0)
                {
                    if (pcol != 0)
                    {
                        for (var j = 0; j < npl; j++)
                        {
                            for (var k = 0;
                                k < p[j].n &&
                                (conto.x - (x + p[j].ox[k])) * (conto.x - (x + p[j].ox[k])) +
                                (conto.y - (y + p[j].oy[k])) * (conto.y - (y + p[j].oy[k])) +
                                (conto.z - (z + p[j].oz[k])) * (conto.z - (z + p[j].oz[k])) >=
                                ((conto.maxR * 10) / pcol) * ((conto.maxR * 10) / pcol);
                                k++) ;
                        }
                    }
                    if (rcol != 0)
