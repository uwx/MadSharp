...
class XTGraphics {
    ...
    internal static void Arrow(int i, int i216, bool abool) {
        ...
        if (!abool) {
            ...
            i224 = (int) (90 + i225 + Math.Atan((CheckPoints.Z[i] - CheckPoints.Opz[Im]) / (double) (CheckPoints.X[i] - CheckPoints.Opx[Im])) / 0.017453292519943295);
        } else {
            var i226 = 0;
            ...
            i224 = (int) (90 + i230 + Math.Atan((CheckPoints.Opz[i226] - CheckPoints.Opz[Im]) / (double) (CheckPoints.Opx[i226] - CheckPoints.Opx[Im])) / 0.017453292519943295);
            if (Multion == 0) {
