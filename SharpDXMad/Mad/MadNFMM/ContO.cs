...
//                        }
            ...
            for (var i27 = 0; i27 < Npl; i27++) {
                ...
                if (is0[i27] == 1) {
                    ...
                    for (var i38 = 0; i38 < P[i27].N; i38++) {
                        ...
                        if (i28 == 1) {
                            var i41 = Math.Abs((int) (Math.Atan((P[i27].Oz[i38] - P[i27].Oz[i39]) / (double) (P[i27].Oy[i38] - P[i27].Oy[i39])) / 0.017453292519943295));
                            var i42 = Math.Abs((int) (Math.Atan((P[i27].Oz[i40] - P[i27].Oz[i39]) / (double) (P[i27].Oy[i40] - P[i27].Oy[i39])) / 0.017453292519943295));
                            if (i41 > 45) {
                                i41 = 90 - i41;
                            } else {
                                i42 = 90 - i42;
                        ...
                        if (i28 == 2) {
                            var i43 = Math.Abs((int) (Math.Atan((P[i27].Oz[i38] - P[i27].Oz[i39]) / (double) (P[i27].Ox[i38] - P[i27].Ox[i39])) / 0.017453292519943295));
                            var i44 = Math.Abs((int) (Math.Atan((P[i27].Oz[i40] - P[i27].Oz[i39]) / (double) (P[i27].Ox[i40] - P[i27].Ox[i39])) / 0.017453292519943295));
                            if (i43 > 45) {
                                i43 = 90 - i43;
                            } else {
                                i44 = 90 - i44;
                        ...
                        if (i28 == 3) {
                            var i45 = Math.Abs((int) (Math.Atan((P[i27].Oy[i38] - P[i27].Oy[i39]) / (double) (P[i27].Ox[i38] - P[i27].Ox[i39])) / 0.017453292519943295));
                            var i46 = Math.Abs((int) (Math.Atan((P[i27].Oy[i40] - P[i27].Oy[i39]) / (double) (P[i27].Ox[i40] - P[i27].Ox[i39])) / 0.017453292519943295));
                            if (i45 > 45) {
                                i45 = 90 - i45;
                            } else {
                                i46 = 90 - i46;
    ...
    internal ContO(ContO conto78, int toX, int toY, int toZ, int i81) {
        ...
        if (conto78.Tnt != 0) {
            for (var i84 = 0; i84 < conto78.Tnt; i84++) {
                Trackers.Xy[Trackers.Nt] = (int) (conto78._txy[i84] * Medium.Cos(i81) - conto78._tzy[i84] * Medium.Sin(i81));
                Trackers.Zy[Trackers.Nt] = (int) (conto78._tzy[i84] * Medium.Cos(i81) + conto78._txy[i84] * Medium.Sin(i81));
                for (var i85 = 0; i85 < 3; i85++) {
                    Trackers.C[Trackers.Nt][i85] = (int) (conto78._tc[i84,i85] + conto78._tc[i84,i85] * (Medium.Snap[i85] / 100.0F));
                ...
                Trackers.X[Trackers.Nt] = (int) (X + conto78._tx[i84] * Medium.Cos(i81) - conto78._tz[i84] * Medium.Sin(i81));
                Trackers.Z[Trackers.Nt] = (int) (Z + conto78._tz[i84] * Medium.Cos(i81) + conto78._tx[i84] * Medium.Sin(i81));
                ...
                Trackers.Radx[Trackers.Nt] = (int) Math.Abs(conto78._tradx[i84] * Medium.Cos(i86) + conto78._tradz[i84] * Medium.Sin(i86));
                Trackers.Radz[Trackers.Nt] = (int) Math.Abs(conto78._tradx[i84] * Medium.Sin(i86) + conto78._tradz[i84] * Medium.Cos(i86));
    ...
    internal ContO(int i, int i90, int i91, int i92, int i93, int i94) {
        ...
        for (var i119 = 0; i119 < 4; i119++) {
            ...
            if (i119 == 0) {
                ...
                Trackers.Zy[Trackers.Nt] = (int) (Math.Atan(Trackers.Rady[Trackers.Nt] / (double) Trackers.Radz[Trackers.Nt]) / 0.017453292519943295);
            ...
            if (i119 == 1) {
                ...
                Trackers.Xy[Trackers.Nt] = (int) (Math.Atan(Trackers.Rady[Trackers.Nt] / (double) Trackers.Radx[Trackers.Nt]) / 0.017453292519943295);
    ...
    internal void D() {
        ...
        var i = Medium.Cx + (int) ((X - Medium.X - Medium.Cx) * Medium.Cos(Medium.Xz) - (Z - Medium.Z - Medium.Cz) * Medium.Sin(Medium.Xz));
        var i124 = Medium.Cz + (int) ((X - Medium.X - Medium.Cx) * Medium.Sin(Medium.Xz) + (Z - Medium.Z - Medium.Cz) * Medium.Cos(Medium.Xz));
        var i125 = Medium.Cz + (int) ((Y - Medium.Y - Medium.Cy) * Medium.Sin(Medium.Zy) + (i124 - Medium.Cz) * Medium.Cos(Medium.Zy));
        ...
        if (Xs(i + MaxR * 2, i125) > Medium.Iw && Xs(i - MaxR * 2, i125) < Medium.W && i125 > -MaxR && (i125 < Medium.Fade[Disline] + MaxR || Medium.Trk != 0) && (i126 > Disp || Medium.Trk != 0) && (!Decor || Medium.Resdown != 2 && Medium.Trk != 1)) {
                ...
                if (!Medium.Crs) {
                    if (i125 < 2000) {
                        ...
                        if (aabool) {
                            ...
                            var i132 = Medium.Cy + (int) ((Medium.Ground - Medium.Cy) * Medium.Cos(Medium.Zy) - (i124 - Medium.Cz) * Medium.Sin(Medium.Zy));
                            var i133 = Medium.Cz + (int) ((Medium.Ground - Medium.Cy) * Medium.Sin(Medium.Zy) + (i124 - Medium.Cz) * Medium.Cos(Medium.Zy));
            ...
            var i136 = Medium.Cy + (int) ((Y - Medium.Y - Medium.Cy) * Medium.Cos(Medium.Zy) - (i124 - Medium.Cz) * Medium.Sin(Medium.Zy));
    ...
    private void Dsprk(bool aabool) {
        ...
        for (var i = 0; i < 100; i++)
            if (_rtg[i] != 0 && (_rbef[i] && aabool || !_rbef[i] && !aabool)) {
                ...
                var i246 = Medium.Cx + (int) ((_rx[i] - Medium.X - Medium.Cx) * Medium.Cos(Medium.Xz) - (_rz[i] - Medium.Z - Medium.Cz) * Medium.Sin(Medium.Xz));
                var i247 = Medium.Cz + (int) ((_rx[i] - Medium.X - Medium.Cx) * Medium.Sin(Medium.Xz) + (_rz[i] - Medium.Z - Medium.Cz) * Medium.Cos(Medium.Xz));
                var i248 = Medium.Cy + (int) ((_ry[i] - Medium.Y - Medium.Cy) * Medium.Cos(Medium.Zy) - (i247 - Medium.Cz) * Medium.Sin(Medium.Zy));
                i247 = Medium.Cz + (int) ((_ry[i] - Medium.Y - Medium.Cy) * Medium.Sin(Medium.Zy) + (i247 - Medium.Cz) * Medium.Cos(Medium.Zy));
                var i249 = Medium.Cx + (int) ((_rx[i] - Medium.X - Medium.Cx + _vrx[i]) * Medium.Cos(Medium.Xz) - (_rz[i] - Medium.Z - Medium.Cz + _vrz[i]) * Medium.Sin(Medium.Xz));
                var i250 = Medium.Cz + (int) ((_rx[i] - Medium.X - Medium.Cx + _vrx[i]) * Medium.Sin(Medium.Xz) + (_rz[i] - Medium.Z - Medium.Cz + _vrz[i]) * Medium.Cos(Medium.Xz));
                var i251 = Medium.Cy + (int) ((_ry[i] - Medium.Y - Medium.Cy + _vry[i]) * Medium.Cos(Medium.Zy) - (i250 - Medium.Cz) * Medium.Sin(Medium.Zy));
                i250 = Medium.Cz + (int) ((_ry[i] - Medium.Y - Medium.Cy + _vry[i]) * Medium.Sin(Medium.Zy) + (i250 - Medium.Cz) * Medium.Cos(Medium.Zy));
    ...
    internal void Dust(int i, float f, float f199, float f200, int i201, int i202, float f203, int i204, bool aabool) {
        var bool205 = false;
        if (i204 > 5 && (i == 0 || i == 2)) {
            bool205 = true;
        }
    ...
    private void Pdust(int i, bool aabool) {
        if (aabool) {
            _sav[i] = (int) Math.Sqrt((Medium.X + Medium.Cx - Sx[i]) * (Medium.X + Medium.Cx - Sx[i]) + (Medium.Y + Medium.Cy - Sy[i]) * (Medium.Y + Medium.Cy - Sy[i]) + (Medium.Z - Sz[i]) * (Medium.Z - Sz[i]));
        }
        if (aabool && _sav[i] > Dist || !aabool && _sav[i] <= Dist) {
            ...
            var i220 = Medium.Cx + (int) ((Sx[i] - Medium.X - Medium.Cx) * Medium.Cos(Medium.Xz) - (Sz[i] - Medium.Z - Medium.Cz) * Medium.Sin(Medium.Xz));
            var i221 = Medium.Cz + (int) ((Sx[i] - Medium.X - Medium.Cx) * Medium.Sin(Medium.Xz) + (Sz[i] - Medium.Z - Medium.Cz) * Medium.Cos(Medium.Xz));
            var i222 = Medium.Cy + (int) ((Sy[i] - Medium.Y - Medium.Cy - _smag[i,7]) * Medium.Cos(Medium.Zy) - (i221 - Medium.Cz) * Medium.Sin(Medium.Zy));
            i221 = Medium.Cz + (int) ((Sy[i] - Medium.Y - Medium.Cy - _smag[i,7]) * Medium.Sin(Medium.Zy) + (i221 - Medium.Cz) * Medium.Cos(Medium.Zy));
            Sx[i] += Scx[i] / (Stg[i] + 1);
            Sz[i] += Scz[i] / (Stg[i] + 1);
            ais = new int[8];
            var is223 = new int[8];
