namespace Cum
{
    internal class Record
    {
        ...
        static void recy(final int i, final float f, final boolean abool, final int i47) {
        ...
        static private void regy(final int i, float f, final boolean abool, final ContO conto, final Mad mad) {
            if (f > 100.0F)
            {
                f -= 100.0F;
                int i50 = 0;
