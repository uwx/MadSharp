    ...
    public class Plane
    {
                ...
                for (var j2 = 0; j2 < 3; j2++)
                    if (j2 != i2)
                        deltaf *= (float) (Math.Sqrt((ox[j2] - ox[i2]) * (ox[j2] - ox[i2]) +
                                                     (oy[j2] - oy[i2]) * (oy[j2] - oy[i2]) +
                                                     (oz[j2] - oz[i2]) * (oz[j2] - oz[i2])) / 100D);
            }
        ...
        public void loadprojf()
        {
            ...
            for (var i = 0; i < 3; i++)
            {
                for (var j = 0; j < 3; j++)
                    if (j != i)
                        projf *= (float) (Math.Sqrt((ox[i] - ox[j]) * (ox[i] - ox[j]) +
                                                    (oz[i] - oz[j]) * (oz[i] - oz[j])) / 100D);
            }
            ...
            int k1, bool flag, bool flag1)
        {
            ...
            if (i1 != 0 || j1 != 0 || l != 0)
            {
                ...
                for (var i2 = 0; i2 < 3; i2++)
                {
                    for (var j2 = 0; j2 < 3; j2++)
                        if (j2 != i2)
                            projf *= (float) (Math.Sqrt((ai[i2] - ai[j2]) * (ai[i2] - ai[j2]) +
                                                        (ai1[i2] - ai1[j2]) * (ai1[i2] - ai1[j2])) / 100D);
                }
            ...
            if (flag3)
            {
                ...
                var i10 = (j8 + k8) / 2;
                var k10 = (l8 + i9) / 2;
                av = (int) Math.Sqrt((m.cy - k9) * (m.cy - k9) + (m.cx - i10) * (m.cx - i10) + k10 * k10 +
                                     l6 * l6 * l6);
                if (av > m.fade[7] || av == 0)
                {
                    flag3 = false;
