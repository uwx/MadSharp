...
namespace MadGame
{
    public class Medium
    {
        ...
        public void behinde(ContO conto)
        {
            ...
            if (i < -90)
                i = -180 - i;
            var k = conto.y + (int) (((conto.y + yart) - conto.y) * Math.Cos(conto.zy * 0.017453292519943295D) -
                                     (conto.z - 600 - conto.z) * Math.Sin(conto.zy * 0.017453292519943295D));
            var l = conto.z + (int) (((conto.y + yart) - conto.y) * Math.Sin(conto.zy * 0.017453292519943295D) +
        ...
        public void watch(ContO conto)
        {
            if (!td)
            {
                ...
                var i = conto.z + (int) ((conto.y - 300 - conto.y) * Math.Sin(conto.zy * 0.017453292519943295D) +
